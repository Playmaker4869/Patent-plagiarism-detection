...
class MyConfig(object):
    def __init__(self, task):
        ...
        self.task_name = task
        self.model_name = roberta  # 模型名称
        self.model_path = './pretrain/roberta/'
        ...
        self.save_path = "evaluation/roberta.ckpt"  # 模型结果
...
def get_edge(sentence):
    ...
    for index, text in enumerate(sentence):
        ...
        while True:
            ...
            numbers = [int(match) for match in re.findall(r'\d+', t)]
