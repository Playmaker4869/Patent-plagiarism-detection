...
from model.longformer import MyConfig, MyDataset, MyModel
...
if __name__ == '__main__':
    ...
    train_set, test_set, val_set = MyDataset(config, train_data), MyDataset(config, test_data), MyDataset(config,
                                                                                                          val_data)
